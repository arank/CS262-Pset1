...
public class Server262 implements Protocol262 {
     ...
     * setting up the remote registry for RMI and establishing a connection to it.
     * This throws no exceptions if it fails though it will print to stderr.
    ...
    /**
     * Retrieves the undelivered queue of messages for a specified user (clearing the existing queue from the server)
     ...
     * @param reciever  the receiver object to push new messages to
     ...
     * @param reciever  the receiver object for the client (to verify that this is indeed the correct person to logout)
     * @throws          Illegal arguement exception if a username does not exist
     */
    @Override
...
/**
 * Interface for an object that dynamically receives messages from a remote client
 */
interface Reciever {
    String getName();
...
class Group implements Reciever {
    ...
    /**
     * Sends a message object to all individual users in the group
